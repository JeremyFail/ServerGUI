...
public class SettingsIO {
    ...
    public static Settings load() throws IOException {
        ...
        if (jsonFile.exists()) {
            ...
            ServerGUI.addToConsole(ServerGUI.getPrefix() + ConsoleColor.RED + "servergui.settings.json could not be parsed; using defaults." + ConsoleColor.RESET);
        ...
        for (String name : LEGACY_FILES) {
            ...
            if (migrated == null) {
                ...
                ServerGUI.addToConsole(ServerGUI.getPrefix() + ConsoleColor.RED + "Failed to migrate legacy settings from \"" + name + "\". Using defaults and generating new settings file." + ConsoleColor.RESET);
                continue;
            }
            ...
            save(migrated);
            legacy.delete();
            ServerGUI.addToConsole(ServerGUI.getPrefix() + ConsoleColor.GREEN + "Migrated settings from \"" + name + "\" to " + JSON_FILE + ".");
            return migrated;
        }
