...
import com.failprooftech.servergui.FileExplorer.FileEditor;
...
public class SettingsPanel extends JPanel {
	...
	public SettingsPanel(ServerGUI gui, Settings settings, ServerSettings serverSettings) {
	...
	// --- Getters for ServerGUI (save, start server, apply accent) ---
